...
class Controller_Site_Base extends Controller {
	...
	public function before()
	{
		...
		$this->_base = URL::base();
		$this->_http_host = url::site(NULL, TRUE);
		...
		$this->_page_title = 'Meadows School - Millbrae';
		$this->_meta_description = 'Millbrae\'s Meadows School serves grades K-5 in the Millbrae Elementary School District. It is among the few public elementary schools in California to receive a distinguished GreatSchools Rating of 9 out of 10.';
		$this->_meta_image = $this->_http_host . 'static/images/template/meadows_logo.jpg';
